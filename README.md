...
<pre>$ sudo apt-get install -y wget unzip git dos2unix python-pip python-requests<br></pre>
<blockquote> <p>CentOS 6.x e 7</p> </blockquote>
<pre>sudo yum install -y epel-release ; sudo yum -y update ; sudo yum install -y wget unzip git dos2unix python-pip python-requests</pre>

<!--
<blockquote> <p>Instale os pacotes </p> </blockquote>
<blockquote> <p> Debian/Ubuntu</p> </blockquote>
<pre>$ sudo apt-get install -y wget unzip git dos2unix python-requests<br></pre>
<blockquote> <p>CentOS 6.x e 7</p> </blockquote>
<pre>sudo yum install -y wget unzip git dos2unix python-requests.noarch</pre>
-->

<blockquote> <p>Faça o download do script de instalação</p> </blockquote>
<pre>cd /tmp ; wget https://raw.githubusercontent.com/sansaoipb/scripts/master/email.sh -O email.sh ; dos2unix email.sh ; sh email.sh</pre>
...
<img src="https://lh3.googleusercontent.com/UA_zorxMjgOZOYstPeaZ9nMn8dYymPR6KNvmNNULCOpQJ6Lryj_6xtKf9hyIhf7bdxFAKSypJkZXi_EXgQ=w425-h107-rw"/><br><br>
...
<b>OBS:</b><br>
<b>1 – </b>Na versão 3.0, é obrigatório a utilização das macros <code>{ALERT.SENDTO}</code>, <code>{ALERT.SUBJECT}</code> e <code>{ALERT.MESSAGE}</code>, em caso de dúvidas, leia a Documentação 
...
<img src="https://lh3.googleusercontent.com/9GUs_XgtNTACYiF94tCVSgt-GGTTcpDV1EakJC8jQIKY6onnVgjAFa7KUEI-a2VzmhWD0EonGq74pklqR7IgHeDqHnFWojCSJy8seDPDWFZSvJi3SGH9EjuSTCYdvrpF_aJsbdwyJNi972Tp5exTWrmdEe6jy5WJ2kddqo4LXBsH4viYwfxZcSKC4aBOzlWmPefRWNh7nOV4ZBnVT9thV4U-2B1nxUC7ZDUzCpEqwn9Y2I1K7lQ7Nq6lgZRuFLLLCPoAfp9wb7dqE2RI9SvjO2xDfAXudjF_Ix_GFzBUovO0vmBHju2WsrVt1l-bctmulPG4RHY8aJbjoVrt2ylOyZr2bcavtt5O4EU1OMJdfxmdijAr7WiFdKb2nJD7b7hpXIM89QXMlzTz1ydOHRnc9TwQJu_6iKoxepCByDvsHF1rlQ6XMoPm9ABUDyOBjBB_ennINBLOftUKCf6QMcuxWbOJPHf8-XIaOW0rnvOVArJ7oNkqqdr-PU9jmpzvLtWA_qQtFj2ffV_5pDPAczJjfzpAMWqDsQs9kThMWbes2dui3QGoP1XzUOCEgI1D3viYHclVsyUwQh4cAro8wiE9Z2xnmhUX8ys8UOOUN5Ji1qBfWzSOM3QfpDyIEZHrOafyhXo0Jw1iz0hOZNTE9fUklxfTkMbsInP81yyMzNQ9dI0g4YYo_npBfg=w428-h255-no"/><br>
...
<img src="https://lh3.googleusercontent.com/_DSNiLFuSENJpLKumyfoWte6_7oxuV2pZvECEseWAaHwlhbDt3mVfiN8WnPfLGJ_WsxaQOe6mertYnofaku6pe6ZPvSpHm6m4ZIfqdVt4xS1yUHS-SvjArtIZcbjZH6uHb24sc52EPkHJ_90IctUvor7AN0bw3SayTSCsD_LPnlhAiiCLevOHdopglwe8jadMqxDr5zN13-HWwinELc2K9--gHvqnAEF72SPtd2E9utW03UZQkkU86K3rl3bvGZP7yGb_L_881YnI3psGXbQEGSIh2VbafSB2Xt4UrSfTCkWrnruawKgol7WeZsXcL55jVrWI9n4DhbjM3Y9Lev3sLUSa49_mvCktzV1Te89F_ONZ9ydSGEkr9M0w16rqNJGtxUL7yUfEnx_gMRSmkOXhQrw8Wt8KBMHQ2A04pFrOvgu6Ji2xs6yEU29V50yYFedpSYpnU2hfiUPV2pGC61qyWOaOm3VMTFil3oFm4ROeJfNxc-20cIDLtlPUseWlK9DlO71JJ9qyjVvZp9eIQcjWGVw_rqPvWLsLY4n-pJAAI1V9be7Hm3jaCIDh1hmy5aGgHEMZGH4bWZUnnbLUwpHkIllWPsoNyS1mP8cchejRXjEoKlF6wEmmla4XlqhmbE-mNAon76YjN5sEHL17GD8CuZkE07P7GPEN9AZ7M6yupDZbV7JklOXjw=w707-h334-no"/>
<br>
<br>
